...
public class MainPage {
	...
	public void mainPageView(int id) throws SQLException {
		...
		JLabel companyNameLabel = new JLabel("Samsung");
		companyNameLabel.setBounds(20, 20, 210, 30);
		companyNameLabel.setHorizontalAlignment(JLabel.CENTER);
		companyNameLabel.setForeground(new Color(255, 153, 51)); // Nice color, e.g., orange
		companyNameLabel.setFont(new Font("Arial", Font.BOLD, 18)); // Increased font size
		optionPanel.add(companyNameLabel);
